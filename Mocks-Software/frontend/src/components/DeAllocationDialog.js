...
function DeAllocationDialog({ interviewer, currentStudent}) {
    ...
    const deallocateStudentMutation = useMutation({
        ...
        onSuccess:(data)=>{
            // console.log(data)
            toast.success('deallocation successfull')
    ...
    const handleSubmit = (e)=>{
        ...
        deallocateStudentMutation.mutate({
            ...
            studentregNo:currentStudent.regNo,
...
export default DeAllocationDialog