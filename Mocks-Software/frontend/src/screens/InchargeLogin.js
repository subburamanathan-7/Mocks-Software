...
function InchargeLogin() {
    const [formData, setFormData] = useState({email:"", password:"",role:"Incharge"})
    ...
    const inchargeLoginMutation = useMutation({
        ...
        onSuccess:(data)=>{
            ...
            sessionStorage.setItem('incharge',data._id)
            sessionStorage.setItem('interviewer',data.interviewer)
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6">
                        ...
                        <div>
                            ...
                            />
                            <label className='m-2' for="check">Show Password</label>
                    ...
                    <p className="mt-10 text-left text-sm text-gray">
                        <a href="/alogin" className="font-semibold leading-6 text-gray hover:underline">Admin Login</a>
                    </p>
                </div>
            </div>
        </>
