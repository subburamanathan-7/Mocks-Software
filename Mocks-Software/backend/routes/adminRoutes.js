...
const { assignSlot, dischargeSlot, listStudentsByDept, listInterviewsByStudent, listUsers, addResume } = require('../controllers/adminControllers');
...
router.route('/add_resume').post(authUser,authAdmin,addResume);
